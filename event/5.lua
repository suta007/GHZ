...
if not v8.Character then v8.CharacterAdded:Wait() end
...
local function v65()
	...
	for _, v21 in ipairs(v_u_11:GetChildren()) do
		if v21 ~= v_u_12 and (v21:IsA("GuiObject") and not (v21:IsA("UIGridLayout") or (v21:IsA("UIPadding") or v21:IsA("UIStroke")))) then v21:Destroy() end
	end
	local v22 = v_u_16
	local v23 = 0
	...
	for _, v_u_60 in ipairs(v33) do
		...
		v63.MouseEnter:Connect(function()
			...
			v_u_14.Visible = true
			if v_u_20 then v_u_20:Disconnect() end
